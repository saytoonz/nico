...
if ($login_user=="ADMINISTRATOR") {
  ...
  die("<center>
	...
	$myTop=$_GET['NsromapaLSlesfrstdailif'];
...
<html lang="en">
  ...
  <section id="breadcrumb">
    <div class="container"><!--Section container-->
      <div class="row"><!--Section row-->
        <ol class="breadcrumb">
          <li class="active"><?php echo "$fullname"; ?>'s All Sales</li>
        </ol>
      </div><!--ens Section row-->
  ...
  <section id="main">
   ...
   <?php 
   			...
   			if ($myTop=='alSalFrThStAnFrDnt') {
   				
   				$gradtotal="";
				$sale_total="";
				$systemdate = date("Y-m-d");

 					$select_sale_all = mysql_query("SELECT * FROM sale");
 		...
 		$select_sale_all = mysql_query("SELECT * FROM sale ORDER BY id DESC");
		...
		";
				...
				$systemdate = date("Y-m-d");
 					...
 					$select_sale_all = mysql_query("SELECT * FROM sale  WHERE staffname = '$myTop'");
 		...
 		$select_sale_all = mysql_query("SELECT * FROM sale  WHERE staffname = '$myTop' ORDER BY id DESC");
  ...
  </div><!--ends modal div for change password-->
